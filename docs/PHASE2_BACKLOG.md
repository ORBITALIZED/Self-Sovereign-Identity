...
> *Corresponding roadmap item: **Phase 2 — Wire Soroban contract end-to-end → emit events consumed by relayer***
...
> *Corresponding roadmap item: **Phase 2 — Wallet integration via `@stellar/freighter-api` + wagmi***
...
> *Corresponding roadmap item: **Phase 2 — Implement Stellar Asset Contract code for wrapped badges (real `WID-…` assets)***
...
> *Corresponding roadmap item: **Phase 2 — Implement AI fraud scorer (logistic regression baseline → gradient boosting)***
...
> *Corresponding roadmap item: **Phase 2 — CI: GitHub Actions running Rust + Foundry + Vitest + pytest***
...
> *Corresponding roadmap item: **Phase 2 — Real Circom circuit — `credential.circom` + `age_verification.circom` fully tested***
...
> *Corresponding roadmap item: **Phase 2 — EVM contracts audited (slither + mythril)***
